...
CREATE TABLE tb_user (
    ...
    provider_type VARCHAR(20)  NOT NULL COMMENT '인증 제공자 타입 (ex.카카오)',
    created_at    TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성일시',
    modified_at   TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정일시',
    PRIMARY KEY (user_id),
...
CREATE TABLE tb_bouquet_link (
    ...
    expired_at      TIMESTAMP    NOT NULL COMMENT '만료일시',
    created_at      TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성일시',
    modified_at     TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정일시',
